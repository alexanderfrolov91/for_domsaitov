	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TEXT':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"><h2 class="bx_catalog_text_title"><a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><div><img src="<?=$arSection["PICTURE"]["SRC"]?>" alt="" title="" /></div><? echo $arSection['NAME']; ?></a><?
				if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
				{
					?> <span>(<? echo $arSection['ELEMENT_CNT']; ?>)</span><?
				}
